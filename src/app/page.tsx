...
const SCHEDULE = {
  "Saturday, April 18": [
    ...
    { time: "11:00 – 11:30 AM", event: "Opening Ceremony", room: "GDC Auditorium" },
    ...
    { time: "1:30 – 2:15 PM", event: "Food", room: "GDC Atrium" },
    { time: "2:15 – 2:30 PM", event: "Dhuhr Prayer", room: "GDC Courtyard", prayer: true },
