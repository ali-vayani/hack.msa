...
import MosqueWeb from "@/components/MosqueWeb";

/* ───────── palette: premium monochrome (warm brown) ───────── */
const C = {
...
@keyframes star-twinkle {
  ...
  50%  { opacity: calc(var(--base-op, 0.15) * 1.35); transform: rotate(var(--rot, 0deg)) scale(1.08); }
