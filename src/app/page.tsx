...
const SCHEDULE = {
  "Saturday, April 18": [
    { time: "8:00 – 10:30 AM", event: "Check-In", room: "GDC Atrium" },
    { time: "11:00 AM – 12:00 PM", event: "Opening Ceremony", room: "GDC Auditorium" },
    { time: "12:00 PM", event: "Hacking Starts"},
    { time: "12:00 – 2:30 PM", event: "Late Check-In / Walk-Ins", room: "GDC Atrium" },
    { time: "12:15 – 1:00 PM", event: "Candid Convos: Being Muslim in Non-Muslim Spaces", room: "GDC 6.302" },
    { time: "1:00 – 2:00 PM", event: "Vibe Coding Workshop", room: "GDC 6.302" },
    { time: "2:00 – 2:45 PM", event: "Food", room: "GDC Atrium" },
    { time: "2:45 – 3:00 PM", event: "Dhuhr Prayer", room: "GDC Courtyard", prayer: true },
    { time: "3:00 – 4:00 PM", event: "Principles of Building Workshop", room: "GDC 6.302" },
    { time: "4:00 – 5:00 PM", event: "Giving Back Workshop", room: "GDC 6.302" },
    { time: "5:00 – 6:00 PM", event: "Go To Market Workshop", room: "GDC 6.302" },
    { time: "6:00 – 7:00 PM", event: "Med Tech Workshop", room: "GDC 6.302" },
    { time: "7:00 – 7:15 PM", event: "Asr Prayer", room: "GDC Courtyard", prayer: true },
    { time: "7:15 – 8:15 PM", event: "Dinner", room: "GDC Atrium" },
    { time: "8:15 – 8:30 PM", event: "Maghrib Prayer", room: "GDC Courtyard", prayer: true },
...
export default function Design7() {
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Discord */}
            <a
              href="https://discord.gg/rVPMgbVM"
              target="_blank"
              rel="noopener noreferrer"
              style={{
                display: "flex",
      ...
      {/* Sticky Discord FAB — mobile only */}
      <a
        href="https://discord.gg/rVPMgbVM"
        target="_blank"
        rel="noopener noreferrer"
        ...
        style={{
          ...
          justifyContent: "center",
          color: "#fff",
          boxShadow: "0 4px 20px rgba(88,101,242,0.4), 0 2px 8px rgba(0,0,0,0.15)",
          transition: "transform 0.2s, box-shadow 0.2s",
        }}
        onMouseEnter={(e) => {
          e.currentTarget.style.transform = "scale(1.08)";
          e.currentTarget.style.boxShadow = "0 6px 28px rgba(88,101,242,0.5), 0 3px 12px rgba(0,0,0,0.2)";
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.transform = "scale(1)";
          e.currentTarget.style.boxShadow = "0 4px 20px rgba(88,101,242,0.4), 0 2px 8px rgba(0,0,0,0.15)";
        }}
      >
